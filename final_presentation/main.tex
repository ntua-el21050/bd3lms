        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.6\textwidth}
                ...
                \begin{table}[t]
                    ...
                    \begin{tabular}{lcc}
                        ...
                        Clipped                                        &                &               \\
                        \hspace{1em}$\mathcal{U}[0.45, 0.95]$          & 1199.43 & \textbf{15.2313} \\
                        \hspace{1em}$\mathcal{U}[0.3, 0.8]$            & 1101.03          & 27.6118         \\
                        Linear $\mathcal{U}[0,1]$                      & 751.15          & 260.1035         \\
                        Logarithmic                                    & 750.05          & 125.6219         \\
                        Square root                                    & \textbf{718.90} & 83.832         \\
                        \midrule \multicolumn{3}{l}{\textbf{$L' = 16$}} \\
                        Clipped                                        &                &               \\
                        \hspace{1em}$\mathcal{U}[0.45, 0.95]$          & 1056.46   & \textbf{4.3476}         \\
                        \hspace{1em}$\mathcal{U}[0.3, 0.8]$            & 797.62 & 6.4124 \\
                        Linear $\mathcal{U}[0,1]$                      & 661.99          & 44.7271          \\
                        Square                                         & \textbf{627.02}          & 27.5325         \\
                        Cosine                                         & 633.59          & 20.8008         \\
                        \bottomrule
                    \end{tabular}%
                    }
                \end{table}
            ...
            \begin{column}{0.38\textwidth}
                ...
                \begin{block}{Table 8 Reproduction}
                    ...
                    \vspace{0.1cm}
                    \emph{The method effectively stabilizes training (low variance) immediately, but PPL gains from this stability likely require a longer training horizon}
                \end{block}
            \end{column}
        \end{columns}
    \end{frame}
...
\multirow{4}{*}{128}                                 & Loglinear                                         & 1000                                          & 10.00          & Gaussian ($\mu=$0.5)            & 1000 & 10.00                          \\
                                                     ...
                                                     & Cosine                                            & 1000                                          & 10.00          & B.G. ($\mu_{1}=0.3, w_{1}=0.6$) & 1000 & 10.00                          \\
                                                     & Cosine $\mathcal{U}[0,\,0.5]$                     & 1000                                          & 10.00          & B.G. ($\mu_{1}=0.1, w_{1}=0.6$) & 1000 & 10.00                          \\
                \midrule

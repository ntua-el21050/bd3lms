...
\begin{document}
        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.42\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    ...
                    % \vspace{0.1cm}
                    \textbf{Key takeaways:}
                        \begin{itemize} \item \textbf{$L'$=4, 128:} Original clipping improves PPL \& Variance; Reproduction shows no significant change. \item \textbf{$L'$=16:} Reproduction mirrors the original's improvements (lower PPL/Variance), but with smaller margins. \end{itemize}
                \end{block}
            \end{column}
        \end{columns}
    \end{frame}
            ...
            \begin{column}{0.42\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    ...
                    \begin{itemize}
                        ...
                        \item \emph{BD3LM trends partly preserved:} Both show smaller $L'$ helps, but original has \emph{all} BD3LM variants beating diffusion.
                    \end{itemize}
                \end{block}
            \end{column}
        \end{columns}
    ...
    \begin{frame}{BD3LMs vs ARs vs Diffusion Models on OWT}
        ...
        \begin{columns}[T,onlytextwidth]
            \begin{column}{0.58\textwidth}
                ...
                Test perplexities (PPL; $\downarrow$) of models on OWT. (3000 Pretraining
                Steps + 3000 Fine-tuning Steps)}
                \vspace{0.2cm}
            ...
            \begin{column}{0.42\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    ...
                    \textbf{Key takeaways:}
                    \begin{itemize}
                        \item \emph{AR $>$ DIFF:} AR outperforms diffusion baselines (lower PPL).

                        \item \emph{BD3LM $>$ AR:} Reverse arrangement of models
                    \end{itemize}

                    \vspace{0.1cm}
                    \emph{Conclusion: Bd3-lms outperform AR small scale models with constrained resources.}
                \end{block}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}{Performance on other Datasets}
        ...
        {Zero-shot validation perplexities ($\downarrow$) of models trained on OWT. (800 Pretraining
        ...
        \begin{block}{Original vs Reproduction}
            ...
            \textbf{Key takeaways:}
            \begin{itemize}
                \item \emph{Wikitext:} Original $\rightarrow$ AR $>$ \textbf{all} and \textbf{Bd3-lms} $>$ Diff \\ Reproduction $\rightarrow$ AR $>$ all, \textbf{Diff} $>$ Bd3-lms.

                \item \emph{LM1B:} Reproduction \textbf{Bd3-lms} $>$ all.

                \item \emph{Lambada:} Original $\rightarrow$ \textbf{Diff} $>$ all \\ Reproduction $\rightarrow$ \textbf{Bd3-lms} $>$ all
    	...
    	\begin{columns}[T,onlytextwidth]
    		...
    		\begin{column}{0.38\textwidth}
    			...
    			\begin{block}{Original vs Reproduction}
    				...
    				\textbf{Key takeaways:}
    				\begin{itemize}
    					\item \emph{Sampling Quality:} Confirmed Bd3-lms $>$ Diff for same NFEs
    					
    					\item \emph{AR performance gap:} AR > all in original vs all > AR in reproduction.
    					
    				\end{itemize}
    				
    				\vspace{0.1cm}
    				\emph{NFEs $\geq L$. Sampling quality improves for Bd3-lms (Gen.PPL;↓). AR models converge slowly.}
    			\end{block}
    		\end{column}
    	\end{columns}
    \end{frame}
        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.38\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    ...
                    \textbf{Key takeaways:}
                    \begin{itemize}
                        \item \emph{Confirmed Variance Hypothesis:} Clipped schedules NELBO variance ↓

                        \item \emph{Perplexity trade-off:} Unlike the paper, standard noise schedules achieve better PPL.
                    \end{itemize}

                    \vspace{0.1cm}
                    \emph{Low variance is achieved in less training steps than PPL gains for small scale models.}
                \end{block}
            \end{column}
        \end{columns}
    \end{frame}

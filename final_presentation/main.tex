...
\begin{document}
        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.5\textwidth}
                \begin{table}
                    ...
                    \begin{tabular}{l l c c}
                        ...
                        \midrule \multirow{2}{*}{128} & $\mathcal{U}[0, 0.5]$   & 2106          & 1.27          \\
            ...
            \begin{column}{0.42\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    \scriptsize
                    % \vspace{0.1cm}
                    \textbf{Key takeaways (Orig. vs Repro.):}
                    \begin{itemize}
                        \item \textbf{$L'=128\ and\ L'=4$:} Original clipping \emph{reduces Var.\ NELBO} and PPL. Reproduction shows no significant changes.

                        \item \textbf{$L'=16$:} Original clipped $\mathcal{U}[0.3,0.8]$ \emph{slightly improves PPL} and \emph{clearly lowers variance} vs $\mathcal{U}[0,1]$; Repro. preserves the \emph{direction} with smaller gaps.
            ...
            \begin{column}{0.42\textwidth}
                ...
                \begin{block}{Original vs Reproduction}
                    ...
                    \begin{itemize}
                        ...
                        \item \emph{BD3LM vs AR flips:} Original ranks AR best overall (BD3LM worse than AR), while reprduction ranks BD3LM best (all BD3LM $<$ AR).
                    \end{itemize}
    ...
    \begin{frame}{Variable-Length Sequence Generation}
        ...
        \begin{table}[t]
            ...
            documents from models trained on OWT (800 Pretraining Steps + 500 Fine-tuning Steps).}
        ...
        \begin{block}{Original vs Reproduction}
            ...
            \textbf{Key takeaways:}
            \begin{itemize}
                \item \emph{Fixed vs variable-length preserved:} In both, SEDD is capped at 1024 max, while BD3LM exceeds 1024; however original shows a much larger BD3LM max than reproduction.

                \item \emph{Median ordering preserved:} Both original and reproduciton keep the same ranking (AR median $>$ SEDD $>$ BD3LM $>$ OWT train).
            \end{itemize}
            \emph{Conclusion: reproduction preserves the ordering, but underestimates BD3LM’s max-length gain, likely missing long-tail samples at this scale.}
        \end{block}
    \end{frame}
    ...
    \begin{frame}{Effect of Different Noise Schedules}
        ...
        \begin{columns}[T,onlytextwidth]
            ...
            \begin{column}{0.38\textwidth}
                \vspace{0.1cm}
                \begin{block}{Table 8 Reproduction}
                    \vspace{0.1cm}
                    \textbf{Key takeaways:}
                    \begin{itemize}
    ...
    \begin{frame}{New Schedules' Results}
        ...
        \begin{itemize}
            ...
            \item We use constant values: $\sigma^2=x$ (Gaussian) and $\sigma_1^2=x, \sigma_2^2=x$ (B.G.) for all experiments. Training under varying $\mu$ and $\mu_1, w_1$\ respectively.  
        \end{itemize}
        }
    ...
    \begin{frame}{Using Bimodal Gaussian on Pretraining}
        ...
        \begin{table}
            ...
            \begin{tabular}{c l l r r}
                ...
                \midrule
                \multirow{2}{*}{128} & Loglinear        & ?????                           & 1000 & 10.00                   \\
                                     & Bimodal Gaussian & ?????                           & 1000 & 10.00                   \\
                \midrule

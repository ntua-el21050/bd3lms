...
\begin{document}
    ...
    \begin{frame}{The Effect of Clipped Noise Schedules}
        ...
        \begin{tabular}{lcccc}
        \toprule
         & \multicolumn{2}{c}{U [0, 0.5]} & \multicolumn{2}{c}{U [0, 1]} \\
        \cmidrule(lr){2-3} \cmidrule(lr){4-5}
        L' & PPL & Var. NELBO & PPL & Var. NELBO \\
        \midrule
        128 & 1000 & 1000 & 1000 & 1000 \\
        \bottomrule
        \end{tabular}
        \end{table}
        ...
        \begin{tabular}{lcccc}
        \toprule
         & \multicolumn{2}{c}{U [0.3, 0.8]} & \multicolumn{2}{c}{U [0, 1]} \\
        \cmidrule(lr){2-3} \cmidrule(lr){4-5}
        L' & PPL & Var. NELBO & PPL & Var. NELBO \\
        \midrule
        ...
        \begin{tabular}{lcccc}
        \toprule
         & \multicolumn{2}{c}{U [0.5, 1]} & \multicolumn{2}{c}{U [0, 1]} \\
        \cmidrule(lr){2-3} \cmidrule(lr){4-5}
        L' & PPL & Var. NELBO & PPL & Var. NELBO \\
        \midrule
        4 & 1226.46 & 44.41 & \textbf{1225.99} & \textbf{44.41} \\
        \bottomrule
        \end{tabular}
        \end{table}

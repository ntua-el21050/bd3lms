            ...
            \begin{column}{0.5\textwidth}
                \begin{table}
                    ...
                    \begin{tabular}{l l c c}
                        ...
                        \midrule \multirow{2}{*}{128} & U [0, 0.5]   & 1000          & 10.00          \\
                                                      & U [0, 1]     & 1000          & 10.00          \\
                        \midrule \multirow{2}{*}{16}  & U [0.3, 0.8] & \textbf{1278} & \textbf{10.50} \\
                                                      & U [0, 1]     & 1279          & 10.51          \\
                        \midrule \multirow{2}{*}{4}   & U [0.5, 1]   & \textbf{1226} & \textbf{44.41} \\
                                                      & U [0, 1]     & \textbf{1226} & \textbf{44.41} \\
                        \bottomrule
                    \end{tabular}
                \end{table}
            \end{column}

...
\begin{document}
    ...
    \begin{frame}{Variable-Length Sequence Generation}
        ...
        \begin{block}{Original vs Reproduction}
            ...
            \textbf{Key takeaways:}
            \begin{itemize}
                \item \emph{Fixed vs variable-length preserved:} SEDD is capped at 1024 max, while BD3LM exceeds 1024; however original shows a much larger BD3LM max than reproduction.
...
\multirow{4}{*}{4}                                   & Loglinear                                         & \textbf{1226}                                 & \textbf{44.41} & Gaussian ($\mu=$0.5)            & 1250 & 46.76                          \\
    ...
    \section{Team Organization}
        ...
        \begin{forest}
            ...
            [Team [Subteam 1 \\
            Members \\
            2 3 4 [Table 1] [Table 2] [Table 3] [Figure 1] [Presentation\\
            (2nd half), font=\itshape] ] [Subteam 2 \\
            Members \\
            1 5 6 [Table 4] [Table 5] [Table 6] [Table 7] [Table 8] [Presentation\\
            (1st half), font=\itshape] ] ]
        \end{forest}
        }
